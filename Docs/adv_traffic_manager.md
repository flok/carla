...
```py
terminal 1: ./CarlaUE5.sh -carla-rpc-port=4000
...
```py
terminal 1: ./CarlaUE5.sh -carla-rpc-port=4000 # simulation A 
terminal 2: ./CarlaUE5.sh -carla-rpc-port=5000 # simulation B
