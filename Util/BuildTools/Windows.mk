...
CarlaUE5Editor: LibCarla
	@"${CARLA_BUILD_TOOLS_FOLDER}/BuildCarlaUE5.bat" --build $(ARGS)

launch: CarlaUE5Editor
	@"${CARLA_BUILD_TOOLS_FOLDER}/BuildCarlaUE5.bat" --launch $(ARGS)
...
clean:
	...
	@"${CARLA_BUILD_TOOLS_FOLDER}/BuildCarlaUE5.bat" --clean
...
rebuild: setup
	@"${CARLA_BUILD_TOOLS_FOLDER}/BuildCarlaUE5.bat" --rebuild
