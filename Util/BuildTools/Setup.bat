...
set CONTENT_DIR=%ROOT_PATH:/=\%Unreal\CarlaUE5\Content\Carla\
set CARLA_DEPENDENCIES_FOLDER=%ROOT_PATH:/=\%Unreal\CarlaUE5\Plugins\Carla\CarlaDependencies\
set CARLA_BINARIES_FOLDER=%ROOT_PATH:/=\%Unreal\CarlaUE5\Plugins\Carla\Binaries\Win64
